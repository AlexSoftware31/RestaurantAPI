        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    OrderInformationOrderId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetail", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderDetail_OrderInformation_OrderInformationOrderId",
                        column: x => x.OrderInformationOrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetail_OrderInformationOrderId",
                table: "OrderDetail",
                column: "OrderInformationOrderId");
        }
